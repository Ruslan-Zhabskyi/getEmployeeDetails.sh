...
# DESCRIPTION: This script returns the name of the employee and their associated expenses

echo Hello, $USER!
echo -e "\vYou can request an employee's salary details by entering their name."
echo -e "\t\vYou can stop this program from running at any time by pressing Control+C"
echo
sleep 1
